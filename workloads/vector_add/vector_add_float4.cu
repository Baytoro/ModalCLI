...
__global__ void vector_add_float4_kernel(const float *a, const float *b, float *out, int64_t n) {
    ...
    const bool aligned = ((reinterpret_cast<uintptr_t>(a + base) | reinterpret_cast<uintptr_t>(b + base) |
...
torch::Tensor vector_add_cuda(torch::Tensor a, torch::Tensor b) {
    ...
    vector_add_float4_kernel<<<blocks, threads>>>(a.data_ptr<float>(), b.data_ptr<float>(), out.data_ptr<float>(), n);
