...
def variant_message(ctx: Dict[str, Any], variant: Dict[str, Any], settings: Dict[str, Any]) -> str:
    """
    Generate a message showing GPU memory bandwidth for reduce sum.
    ...
    # Reduce sum: read input array (n elements), write scalar output (negligible)
    # Each element is 4 bytes (float32)
    bytes_per_element = 4  # float32
    total_bytes = n * bytes_per_element  # 1 read + negligible write
